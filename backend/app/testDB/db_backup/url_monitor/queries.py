...
class QueryManager:
    ...
    INSERT_CHANGE = """
        INSERT INTO changes (
            ...
            old_response_body, new_response_body, old_headers, 
            new_headers, old_response_time, new_response_time, change_type
        ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
    """

    # Select queries
    SELECT_ENDPOINT_DATA = """
        SELECT last_status_code, last_response_size, last_body_hash, 
               last_response_body, last_headers, response_time, id 
