...
# Table creation queries
    ...
    CREATE_TABLE_LIST = [CREATE_ENDPOINTS_TABLE, CREATE_PROGRAMS_TABLE, CREATE_WEB_TARGETS_TABLE, CREATE_MOBILE_TARGETS_TABLE]
...
# Insert queries
    ...
    INSERT_ENDPOINT = """
        INSERT INTO monitor_endpoints (
            url, old_status_code, new_status_code,
            old_response_size, new_response_size, old_body_hash, new_body_hash, old_body_file_path, new_body_file_path, change_detected_at, last_check
            )
...
# Select queries
    ...
    SELECT_ENDPOINT_DATA_BY_URL = """
        SELECT id, url, old_status_code, new_status_code,
            old_response_size, new_response_size, old_body_hash, new_body_hash, old_body_file_path, new_body_file_path, change_detected_at, last_check
    ...
    SELECT_ALL_ENDPOINTS = """
        SELECT id, url FROM monitor_endpoints
    """
